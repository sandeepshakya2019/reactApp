    ...
    <div>
      ...
      <div className="defination">
        ...
        <p className="define-text">
          ReactJs is a JavaScript Library for buliding the User Interfaces (UI)
        </p>

        <p className="define-text">
          <b>JavaScript Library</b> Means they simply runs in browser. we don't
          have to wait the server response. It Let's you to compose the complex
          UI from Small and Isolated Piece of Code are called
        ...
        <p className="define-text">
          ...
          Components have a JavaScript function that return a piece of code that
          repersents a piece of page
          <br />
      ...
      <div className="explanation">
        ...
        <br />
        <p className="define-text ">
          If we have a project which is already setup in HTML,CSS,JavaScript we
          can also add the React to that Project. Follow the ScreenShot. If you
          don't Understand the syntax yet don't worry we will cover in upcomping
          lessons.
        </p>
        <img
          alt="xcode"
        ...
        <p className="define-text ">
          ...
          <br />
          All of the React Components have a <b> Render functionality </b>which
          specifies the HTML output of a react Components written in JSX syntax.
          <b>"JSX Syntax"</b>
